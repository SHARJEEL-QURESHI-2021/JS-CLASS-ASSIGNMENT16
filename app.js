...
function search(){
    ...
    if (s == "HAPPY NEW YEAR") {
        ...
        nme.innerHTML = "Ramadan / " + "<br>" + "Pakistan Day";
        image.src = "./img/6.avif";
    }
    else if (s == "EID-UL-FITR") {
        passedOrUpcoming();
    ...
    else if (s == "TEACHER DAY") {
        passedOrUpcoming();
        date.value = "2023-05-09";
        nme.innerHTML = "Teacher's Day";
        image.src = "./img/9.png";
    }
    else if (s == "MOTHER DAY") {
        passedOrUpcoming();
    ...
    else if (s == "EID-UL-ADHA") {
        passedOrUpcoming();
        date.value = "2023-06-30";
        nme.innerHTML = "Eid-ul-Adha";
        image.src = "./img/11.webp"
    }
    else if (s == "FATHER DAY") {
        passedOrUpcoming();
        date.value = "2023-06-18";
        nme.innerHTML = "Father's Day";
        image.src = "./img/12.jpg";
    }
    else if (s == "YOUM-E-ASHURA") {
        passedOrUpcoming();
    ...
    else if (s == "QUAID DAY" || s == "CHRISTMAS") {
        passedOrUpcoming();
